#Test suite for temp_trends

import unittest
import pylab
import math

import temp_trends as ps5
...
class TestPS5(unittest.TestCase):
	...
	def test_gen_cities_avg(self):
		...
		for index in range(len(correct)):
			good_enough = ps5.isclose(correct[index], result[index])
	...
	def test_rmse(self):
		...
		self.assertTrue(ps5.isclose(correct, result), "RMSE value incorrect")
